...
@section('content')
    <div class="box-body">
    <form action="{{url('/admin/doAddGoods')}}" method="post" class="form-horizontal" enctype="multipart/form-data">

            @csrf
            <div class="form-group">
                <label for="exampleInputEmail1" class="col-sm-2 control-label">商品名称：</label>
                <div class="col-sm-10"><input type="text" name="goods_name" class="form-control"></div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="number" name="goods_count" class="form-control">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div id="editor"></div>
                    <textarea name="goods_desc" id="text1" class="form-control" style="height:200px;display: none;"></textarea>
                </div>
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1" class="col-sm-2 control-label">商品分类：</label>
                <div class="col-sm-10">
                    <select name="cate_id" id="cateid" onchange="selectAttr()" class="form-control">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10" id="addImg"><div><a href="javascript:void(0);" onclick="addImg(this)">[+]</a>图片描述 <input type="text" name="img_desc[]">上传文件 <input type="file" name="goods_img[]" style="position:absolute;display: inline-block;"></div></div>
            </div>
