		...
		<div class="regist">
			<div class="regist_center">
				...
				<div class="regist_main center">
					<div class="username">用&nbsp;&nbsp;户&nbsp;&nbsp;名:&nbsp;&nbsp;<input class="shurukuang" type="text" name="username" placeholder="请输入邮箱或者手机号" id="username" onblur="checkusername()"/><span id="checkname">邮箱或者手机号用于登录</span></div>
					...
					<div class="username">确认密码:&nbsp;&nbsp;<input class="shurukuang" type="password" name="repassword" placeholder="请确认你的密码" id="repassword" onblur="checkrepwd()"/><span id="checkrepwd">两次密码要输入一致哦</span></div>
					<div class="username">
